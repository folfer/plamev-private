...
export const Plan = ({
  ...
  bonusPlan,
  initialValue,
  finalValue }: IPlanLayoutProps) => {
  return (
    <div className={styles.planContainer}>

      <div className={styles.planHeader}>
        <div className={styles.planType}>
          <input className={styles.planInput} type="checkbox" />
          <h1 className={styles.planTitle}>{planTitle}</h1>
        </div>

        <div className={styles.planValue}>
          <p className={styles.initialValue}>de <s>R$ {initialValue}</s> por:</p>
      ...
      <div className={styles.planDescription}>
        <div className={styles.paragraphContainer}>
          <p className={styles.paragraph}>Taxa <b>ZERO</b> de adesão</p>
        ...
        <button className={styles.link}><u>ver cobertura</u></button>
      </div>
    </div>
  );
}